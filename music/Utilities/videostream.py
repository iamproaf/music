...
from music import BOT_USERNAME, db_mem
from music.Core.PyTgCalls import Queues
from music.Core.PyTgCalls.music import (join_live_stream, join_video_stream,
                                        stop_stream)
from music.Database import (add_active_chat, add_active_video_chat,
                            is_active_chat, music_off, music_on,
                            remove_active_chat)
from music.Inline import (audio_markup, audio_markup2, primary_markup,
