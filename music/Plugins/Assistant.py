...
from music import ASSISTANT_PREFIX, SUDOERS, app, random_assistant
from music.Database import get_assistant, save_assistant
...
async def assis_change(_, message: Message):
    ...
    if not _assistant:
        await message.reply_text(
            f"**__music Music Bot Assistant Alloted__**\n\nAssistant No. **{ran_ass}**"
        )
        assis = {
