...
from music import ASSIDS, BOT_ID, MUSIC_BOT_NAME, OWNER_ID, SUDOERS, app
from music import boottime as bot_start_time
from music import db, random_assistant
from music.Core.PyTgCalls import music
from music.Database import (add_nonadmin_chat, add_served_chat,
...
async def start_markup_check(_, CallbackQuery):
    ...
    if command == "DIT":
        ...
        await CallbackQuery.answer(
            f"music Disk Usage: {diske}%", show_alert=True
        )
