...
from music.Core.PyTgCalls.music import (pause_stream, resume_stream,
                                        skip_stream, skip_video_stream,
                                        stop_stream)
from music.Database import (is_active_chat, is_music_playing, music_off,
                            music_on, remove_active_chat,
                            remove_active_video_chat)
from music.Decorators.admins import AdminRightsCheck
from music.Decorators.checker import checker, checkerCB
from music.Inline import audio_markup, primary_markup, secondary_markup2
